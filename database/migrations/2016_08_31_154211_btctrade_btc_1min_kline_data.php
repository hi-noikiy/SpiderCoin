...
class BtctradeBtc1minKlineData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('btctrade_btc_1min_kline_data', function (Blueprint $table) {
    ...
    {
        Schema::drop('btctrade_btc_1min_kline_data');
