...
class PoloniexBtc1minKlineData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('poloniex_btc_1min_kline_data', function (Blueprint $table) {
    ...
    {
        Schema::drop('poloniex_btc_1min_kline_data');
    }
}
