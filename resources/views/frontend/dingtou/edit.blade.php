    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form">
                ...
                <form class="form-horizontal" id="aip-form" action="{{ route('dingtou.update', ['id'=> $aipData['id']]) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <span id="Aip_currency">
                                <input class="col-sm-2 control-label" id="Aip_currency_0" value="btc_cny" {{  $aipData['currency'] == 'btc_cny' || empty( $aipData['currency']) ? 'checked' : '' }} type="radio" name="currency">
                                <label for="Aip_currency_0">BTC</label><br>
                                <input class="col-sm-2 control-label" id="Aip_currency_1" value="ltc_cny" {{  $aipData['currency'] == 'ltc_cny' ? 'checked' : '' }} type="radio" name="currency">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <span id="Aip_aip_type">
                                <input class="col-sm-2 control-label" id="Aip_aip_type_0" value="1" {{  $aipData['aip_type'] == 1 || empty( $aipData['aip_type']) ? 'checked' : '' }} type="radio" name="aip_type">
                                <label for="Aip_aip_type_0">价格定投</label>
                                <br>
                                <input class="col-sm-2 control-label" id="Aip_aip_type_1" value="2" {{  $aipData['aip_type'] == 2 ? 'checked' : '' }} type="radio" name="aip_type">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" name="per_amount" value="{{ $aipData['per_amount'] }}" id="Aip_per_amount" type="number"></div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" name="stop_profit_percentage" value="{{  $aipData['per_amount'] }}" id="Aip_stop_profit_percentage" type="text"></div>
                        <div class="col-sm-4">
                            <p class="text-success">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" name="fund" value="{{ $aipData['fund'] }}" id="Aip_fund" type="text">
                        </div>
                        <div class="col-sm-4">
                            <p class="text-success">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" name="drawdown"  id="Aip_drawdown" type="number" value="{{  $aipData['drawdown'] }}">
                        </div>
                        <div class="col-sm-4">
                            <p class="text-success">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="col-sm-12 row">
                                <input type="radio" class="col-sm-2" name="period" value="1"  {{  $aipData['period'] == 1 || empty( $aipData['aip_type']) ? 'checked' : '' }}  autocomplete="off" checked=""> 每月
                            </div>
                            <div class="col-sm-12 row">
                                    @if(!empty($aipData['day']))
                                        @for($i = 1;$i<29;$i++)
                                            <input type="checkbox" name="day[]"  {{  in_array($i,$aipData['day']) ? 'checked' : '' }} value="{{ $i }}" > {{ $i }}
                                        @endfor
                                    @else
                                        @for($i = 1;$i<24;$i++)
                            ...
                            <div class="col-sm-12 row">
                                <input type="radio" name="period" class="col-sm-2"  value="2"  {{  $aipData['period'] == 2 ? 'checked' : '' }}  autocomplete="off" checked=""> 每天
                            </div>

                            <div class="col-sm-12 row">
                                @if(!empty($aipData['hour']))
                                    @for($i = 1;$i<24;$i++)
                                        <input type="checkbox" name="hour[]"  {{  in_array($i,$aipData['hour'])? 'checked' : '' }} value="{{ $i }}" > {{ $i }}
                                    @endfor
                                @else
                                    @for($i = 1;$i<24;$i++)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" name="amount_limit" id="Aip_amount_limit" type="text" value="{{ $aipData['amount_limit'] }}">
                        </div>
                        <div class="col-sm-4">
                            <p class="text-success">
