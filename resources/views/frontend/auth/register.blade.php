...
<head>
    ...
    <title>Ding Tou CMS</title>
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <link rel="stylesheet" type="text/css" href="{{ elixir('assets/backend/css/app.min.css') }}">
</head>
<body id="login" class="hold-transition login-page" style="background-image: url('{{array_random(config('dingtou.background-images'))}}');">
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="{{URL::to('/auth/register')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group has-feedback">
                        <input type="password" class="form-control" placeholder="重复密码" name="password_confirmation" value="{{old('repeat_password')}}">
                        <span class="fa fa-lock form-control-feedback"></span>
                        @include('backend.layout.tip',['field'=>'password'])
                    </div>
                </div>
            </div>
            <div class="row col-xs-4 collapse navbar-collapse ">
            ...
            <div class="row" style="padding-top: 5px;">
                <div class="col-xs-4 pull-right">
                    <button type="submit" class="btn btn-success btn-block btn-flat">注 册</button>
                </div>
            </div>
        </form>
    </div>
